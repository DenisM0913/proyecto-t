            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="datosConyuge.jsp">Regresar</a>
                        </li>
                ...
                <div class="col-lg-6 mx-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-5">
                            ...
                            <h2 class="text-center mb-5">Agregar/Modificar registro del conyuge</h2>
                            <!-- Formulario de inicio de sesión con acción "Servlet1" y método POST -->
                            <form action="ServletInsertDatosConyuge" method="post">
