        ...
        <div class="centered-container ">
            ...
            <div class="container">
                ...
                <button class="btn btn-custom ">
                    <img src="./iconos/asistencia.png" onclick="window.location.href = 'asistenciasCrud.jsp'">
                    Asistencias
                </button>
                <br>
                <button class="btn btn-custom ">
                    <img src="./iconos/permisos.png" onclick="window.location.href = 'permisosCrud.jsp'">
                    Permisos
                </button>
                <br>
                <button class="btn btn-custom ">
                    <img src="./iconos/loggin.png"  onclick="window.location.href = 'modificar.jsp'">
                    Usuario
                </button>
            </div>
            ...
            <div class="container">
                ...
                <button class="btn btn-custom mb-3">
                    <img src="./iconos/capaciones.png" onclick="window.location.href = 'capasitacion.jsp'">
                    Capasitación 
                </button>
                <br>
                <button class="btn btn-custom ">
                    <img src="./iconos/contactoEmergencia.png" onclick="window.location.href = 'contactoEmergencia.jsp'">
                    Contacto de emergencia
                </button>
                <br>
                <button class="btn btn-custom ">
                    <img src="./iconos/conyuge.png"  onclick="window.location.href = 'datosConyuge.jsp'">
                    Datos del conyuge
                </button>
            ...
            <div class="container">
                <button class="btn btn-custom ">
                    <img src="./iconos/evaluacion.png"  onclick="window.location.href = 'evalucionDesempe.jsp'">
                    Evaluacion desempeño
                </button>
                <br>
                <button class="btn btn-custom ">
                    <img src="./iconos/academico.png" onclick="window.location.href = 'formacionAcademica.jsp'">
                    Formacion academica
                </button>
                <br>
                <button class="btn btn-custom ">
                    <img src="./iconos/hijos.png"  onclick="window.location.href = 'hijos.jsp'">
                    Hijos
                </button>
            ...
            <div class="container">
                <button class="btn btn-custom ">
                    <img src="./iconos/banco.png" onclick="window.location.href = 'infomacionBancaria.jsp'">
                    Informacion bancaria
                </button>
                <br>
                <button class="btn btn-custom ">
                    <img src="./iconos/senecyt.png"  onclick="window.location.href = 'senescytCrud.jsp'">
                    Situacion del senescyt
                </button>
                <br>
                <button class="btn btn-custom ">
                    <img src="./iconos/enfermedad.png"  onclick="window.location.href = 'enfermedadCrud.jsp'">
                    Discapacidad o enfermedad
                </button>
            </div>
            <div class="container">
                <button class="btn btn-custom ">
                    <img src="./iconos/trayectoria.png"  onclick="window.location.href = 'trayectoriaLaboralCrud.jsp'">
                    Trayectoria laboral
                </button>
                <br>
                <button class="btn btn-custom ">
                    <img src="./iconos/enbarazada.png"  onclick="window.location.href = 'inclucionLaboralCrud.jsp'">
                    Inclucion laboral
                </button>
                <br>

                <button class="btn btn-custom ">
                    <img src="./iconos/salir.png" onclick="window.location.href = 'index.jsp'">
                    Cerrar sesion
                </button>
            </div>
        </div>
