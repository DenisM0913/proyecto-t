...
<html>
    ...
    <body style="background-color: #800000">
                ...
                <div class="col-md-20 offset-md-0">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <p style="font-size: larger;"><b>Gestion de datos de hijos de docente</b></p>
                            ...
                            <form action="ServletGestionHijo" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="deleteId" class="form-label">ID para eliminar contacto emergencia</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="idUpdate" class="form-label">ID para editar contacto emergencia</label>
      ...
      <th>Id</th>
                                        ...
                                        <th>Cedula del hijo</th>
                                        <th>numero de hijo</th>
                                        <th>nombres</th>
                                        <th>Apellidos</th>
                                        <th>Fecha de nacimiento</th>
                                        <th>Nivel de instrucion</th>
                    ...
                    <tr onclick="redirectToHijoInsert('<%= capas.getIdHijo() %>')">
