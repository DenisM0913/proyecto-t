        ...
        <div class="container mt-3 ">
                ...
                <div class="col-md-20 offset-md-0">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <p style="font-size: larger;"><b>Gestion de la inclucion laboral</b></p>
                            ...
                            <form action="ServletGestionInclusionLaboral" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="deleteId" class="form-label">ID para eliminar inclucion laboral</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="idUpdate" class="form-label">ID para editar es migrante</label>
                                ...
                                <a href="inclucionLaboralInsert.jsp" class="btn btn-light text-dark border-dark">EDITAR TODO</a>


                            </div>
                            <div class="col-md-6">
                                <label for="datos" class="form-label">Migrante</label>
            ...
            <div class="col-sm-18">
                <table class="table table-hover">
                    ...
                    <tr onclick="redirectToAsistenciasInsert('<%= capas.getIdInclucionLaboral() %>')">
