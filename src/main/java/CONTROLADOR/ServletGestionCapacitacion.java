 ...
 * @author david
 */
@WebServlet(name = "ServletGestionCapacitacion", urlPatterns = {"/ServletGestionCapacitacion"})
public class ServletGestionCapacitacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionCapacitacion</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionCapacitacion at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Capasitacion> arrobj = new ArrayList();
    ...
    try {
                ...
                Capasitacion objupdate = new Capasitacion(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("capasitacion.jsp");
