 ...
 * @author david
 */
@WebServlet(name = "ServletGestionTrauectoriaLaboral", urlPatterns = {"/ServletGestionTrauectoriaLaboral"})
public class ServletGestionTrauectoriaLaboral extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionTrauectoriaLaboral</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionTrauectoriaLaboral at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    try {
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("trayectoriaLaboralCrud.jsp");
