 ...
 * @author david
 */
@WebServlet(name = "ServletInsertCapasitacion", urlPatterns = {"/ServletInsertCapasitacion"})
public class ServletInsertCapasitacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletInsertCapasitacion</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletInsertCapasitacion at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      // Verificación de existencia de idAsistencia en la solicitud
        ...
        switch (op.toUpperCase()) {
            ...
            case "EDITAR":
                Capasitacion objact = new Capasitacion(idCapasitacion, nombreEvento, 
                        tipoEvento, auspiciante, duracionHoras, tipoCertificado, certificadoPor,
                        fechaInicio, fechaFin, pais, usuario_idCedula);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("capasitacionInsert.jsp");
