 ...
 * @author david
 */
@WebServlet(name = "ServletInsertFormacionAcademica", urlPatterns = {"/ServletInsertFormacionAcademica"})
public class ServletInsertFormacionAcademica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletInsertFormacionAcademica</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletInsertFormacionAcademica at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
  ...
  //zona de variables
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("formacionAcademicaInsert.jsp");
