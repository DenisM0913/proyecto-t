 ...
 * @author david
 */
@WebServlet(name = "ServletGestionInclusionLaboral", urlPatterns = {"/ServletGestionInclusionLaboral"})
public class ServletGestionInclusionLaboral extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionInclusionLaboral</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionInclusionLaboral at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<InclucionLaboral> arrobj = new ArrayList();
    ...
    try {
                ...
                InclucionLaboral objupdate = new InclucionLaboral(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("inclucionLaboralCrud.jsp");
