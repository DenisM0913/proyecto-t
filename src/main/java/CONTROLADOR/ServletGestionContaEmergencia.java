 ...
 * @author david
 */
@WebServlet(name = "ServletGestionContaEmergencia", urlPatterns = {"/ServletGestionContaEmergencia"})
public class ServletGestionContaEmergencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionContaEmergencia</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionContaEmergencia at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       int idUpdate = 0;
        ...
        ArrayList<ContactoEmergencia> arrobj = new ArrayList();
    ...
    try {
                ...
                ContactoEmergencia objupdate = new ContactoEmergencia(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("contactoEmergencia.jsp");
