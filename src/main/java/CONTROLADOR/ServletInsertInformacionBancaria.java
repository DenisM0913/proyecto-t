 ...
 * @author david
 */
@WebServlet(name = "ServletInsertInformacionBancaria", urlPatterns = {"/ServletInsertInformacionBancaria"})
public class ServletInsertInformacionBancaria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletInsertInformacionBancaria</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletInsertInformacionBancaria at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    //estas variables se usaran para recibir los datos 
       ...
       // Verificación de existencia de idAsistencia en la solicitud
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("informacionBancariaInsert.jsp");
