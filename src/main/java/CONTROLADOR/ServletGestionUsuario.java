...
public class ServletGestionUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionUsuario</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionUsuario at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       int idUpdate = 0;
        ...
        ArrayList<Usuario> arrobj = new ArrayList();
    ...
    try {
                ...
                Usuario objupdate = new Usuario(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("modificar.jsp");
