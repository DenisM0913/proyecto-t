 ...
 * @author david
 */
@WebServlet(name = "ServletGestionInformacionBancaria", urlPatterns = {"/ServletGestionInformacionBancaria"})
public class ServletGestionInformacionBancaria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionInformacionBancaria</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionInformacionBancaria at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<InformacionBancaria> arrobj = new ArrayList();
    ...
    try {
                ...
                InformacionBancaria objupdate = new InformacionBancaria(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("infomacionBancaria.jsp");
