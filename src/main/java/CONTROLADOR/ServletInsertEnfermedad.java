...
public class ServletInsertEnfermedad extends HttpServlet {
    ...
    int usuario_idCedula;
        ...
        String idAsistenciaParam = request.getParameter("idUpdate");
        if (idAsistenciaParam != null && !idAsistenciaParam.isEmpty()) {
            idDiscapacidadOenfermedad = Integer.parseInt(idAsistenciaParam);
        } else {
     ...
     //estas variables se usaran para recibir los datos 
        ...
        situacionnumeroCarnetConadis = request.getParameter("situacionnumeroCarnetConadis");
        ...
        switch (op.toUpperCase()) {
            case "GUARDAR":
                DiscapacidadOenfermedad objInsert = new DiscapacidadOenfermedad(situacion,
                        ...
                        tipoDiscapacidad, porcentaje, tipoEnfermedad, tipoRelacion, usuario_idCedula);
            ...
            case "EDITAR":
                DiscapacidadOenfermedad objact = new DiscapacidadOenfermedad(idDiscapacidadOenfermedad,
                        situacion, situacionnumeroCarnetConadis, certificadoEnfermedadCarastrofica,
                        tipoDiscapacidad, porcentaje, tipoEnfermedad, tipoRelacion, usuario_idCedula);
