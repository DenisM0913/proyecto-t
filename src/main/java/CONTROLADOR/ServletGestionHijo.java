 ...
 * @author david
 */
@WebServlet(name = "ServletGestionHijo", urlPatterns = {"/ServletGestionHijo"})
public class ServletGestionHijo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionHijo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionHijo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Hijo> arrobj = new ArrayList();
    ...
    try {
                ...
                Hijo objupdate = new Hijo(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("hijos.jsp");
