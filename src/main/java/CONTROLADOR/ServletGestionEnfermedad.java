 ...
 * @author david
 */
@WebServlet(name = "ServletGestionEnfermedad", urlPatterns = {"/ServletGestionEnfermedad"})
public class ServletGestionEnfermedad extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionEnfermedad</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionEnfermedad at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       int idUpdate = 0;
        ...
        ArrayList<DiscapacidadOenfermedad> arrobj = new ArrayList();
    ...
    try {
                ...
                DiscapacidadOenfermedad objupdate = new DiscapacidadOenfermedad(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("enfermedadCrud.jsp");
