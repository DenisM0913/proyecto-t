 ...
 * @author david
 */
@WebServlet(name = "ServletGestionFormacionAcademica", urlPatterns = {"/ServletGestionFormacionAcademica"})
public class ServletGestionFormacionAcademica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionFormacionAcademica</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionFormacionAcademica at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       int idUpdate = 0;
        ...
        ArrayList<FormacionAcademica> arrobj = new ArrayList();
    ...
    try {
                ...
                FormacionAcademica objupdate = new FormacionAcademica(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("formacionAcademica.jsp");
