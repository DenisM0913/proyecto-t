 ...
 * @author david
 */
@WebServlet(name = "ServletGestionDatosConyuge", urlPatterns = {"/ServletGestionDatosConyuge"})
public class ServletGestionDatosConyuge extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionDatosConyuge</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionDatosConyuge at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<DatosConyuge> arrobj = new ArrayList();
    ...
    try {
                ...
                DatosConyuge objupdate = new DatosConyuge(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("datosConyuge.jsp");
