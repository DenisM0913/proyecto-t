 ...
 * @author david
 */
@WebServlet(name = "ServletGestionPermiso", urlPatterns = {"/ServletGestionPermiso"})
public class ServletGestionPermiso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionPermiso</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionPermiso at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       int idUpdate = 0;
        ...
        ArrayList<Permiso> arrobj = new ArrayList();
    ...
    try {
                ...
                Permiso objupdate = new Permiso(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("permisosCrud.jsp");
