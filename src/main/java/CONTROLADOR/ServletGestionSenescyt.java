 ...
 * @author david
 */
@WebServlet(name = "ServletGestionSenescyt", urlPatterns = {"/ServletGestionSenescyt"})
public class ServletGestionSenescyt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionSenescyt</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionSenescyt at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<SituacionSenescyt> arrobj = new ArrayList();
    ...
    try {
                ...
                SituacionSenescyt objupdate = new SituacionSenescyt(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("senescytCrud.jsp");
