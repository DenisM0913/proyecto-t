 ...
 * @author david
 */
@WebServlet(name = "ServletGestionTrayectorialLaboral", urlPatterns = {"/ServletGestionTrayectorialLaboral"})
public class ServletGestionTrayectorialLaboral extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletGestionTrayectorialLaboral</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletGestionTrayectorialLaboral at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<TrayectoriaLaboral> arrobj = new ArrayList();
    ...
    try {
                ...
                TrayectoriaLaboral objupdate = new TrayectoriaLaboral(idUpdate, datos);
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("trayectoriaLaboral.jsp");
